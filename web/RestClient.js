...
// Model for Personnel entity
    models.Personnel = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/webproj/webresources/pack.personnel/",
        idAttribute: 'id',
        defaults: {
            matle: "",
            adresse: "",
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:8080/webproj/webresources/pack.personnel/';
            }
    ...
    models.PersonnelCollection = Backbone.Collection.extend({
        ...
        url: "http://localhost:8080/webproj/webresources/pack.personnel/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
